...
class BaseContent(models.Model):
    ...
    description = models.TextField(default="", verbose_name="게임 설명")
...
class BoardGame(BaseContent):
    difficulty  = models.CharField(max_length=10, default="", verbose_name="난이도")
    publisher   = models.CharField(max_length=300, default="", verbose_name="출판사")
    designer    = models.CharField(max_length=300, default="", verbose_name="디자이너")
    ...
    category    = models.CharField(max_length=300, default="", verbose_name="카테고리")
    mechanism   = models.CharField(max_length=500, default="", verbose_name="메커니즘")
    tags        = models.JSONField(default=list, verbose_name="태그")
    name_eng    = models.CharField(max_length=200, default="", verbose_name="영어 이름")
...
class Escape(BaseContent):
    difficulty  = models.CharField(max_length=10, default="", verbose_name="난이도")
    region      = models.CharField(max_length=50, default="", verbose_name="지역")
    brand       = models.CharField(max_length=100, default="", verbose_name="브랜드")
    theme       = models.CharField(max_length=100, default="", verbose_name="테마")
...
class CrimeScene(BaseContent):
    difficulty   = models.CharField(max_length=10, default="", verbose_name="난이도")
    series       = models.CharField(max_length=100, default="", verbose_name="시리즈")
    maker        = models.CharField(max_length=100, default="", verbose_name="제작")
    publisher    = models.CharField(max_length=100, default="", verbose_name="출판사")
    publisher_kr = models.CharField(max_length=100, default="", verbose_name="국내 출판사")
    tags         = models.JSONField(default=list, verbose_name="태그")
